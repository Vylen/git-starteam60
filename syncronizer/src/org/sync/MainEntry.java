...
public class MainEntry {
  ...
  public static void main(String[] args) {
    ...
    CmdLineParser.Option listAllViews = parser.addBooleanOption("list-views");
    ...
    Boolean listAllFlag = (Boolean) parser.getOptionValue(listAllViews);
    boolean listAll = listAllFlag != null && listAllFlag;
    ...
    if(host == null || port == null || (project == null && listAllFlag == null) || (view == null && !allViews && listAllFlag == null)) {
      printHelp();
      System.exit(3);
    }
    ...
    if(userid > 0) {
      ...
      if (listAll) {
        for (Project p : starteam.getProjects()) {
          System.out.println("In Project: [ " + p.getName() + " ]");
          printViewsRecurse(p.getDefaultView(), 0);
          System.out.println("");
        }
      } else {
        ...
        for(Project p : starteam.getProjects()) {
          if(p.getName().equalsIgnoreCase(project)) {
            ...
            try {
              ...
              if ( Files.notExists(Paths.get(logsDir.toURI())) ) { 
                logsDir.mkdir();
              }
              NetMonitor.onFile(new java.io.File("./logs/netmon.out"));
  ...
  public static void printViewsRecurse(View parentView, int level)
  {
    for ( int i = 0; i < level; ++i ) { System.out.print(" "); }
    System.out.println("  : " + parentView.getName());
    for (View child : parentView.getDerivedViews()) {
      printViewsRecurse(child, level + 2);
    }
  }
  ...
  public static void printHelp() {
    ...
    System.out.println("--list-views\t\tPrint out a list of views");
